FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`),
...
INSERT INTO `director` VALUES ('张艺谋','https://p0.pipi.cn/basicdata/25bfd6512ffc7e16bdc9fd9382ab74232cd0c.jpg?imageView2/1/w/128/h/170'),('易小星','https://p0.pipi.cn/basicdata/fb73860253733821f0d236331ec8b7720de04.jpg?imageView2/1/w/128/h/170'),('郭帆','https://p0.pipi.cn/basicdata/25bfd6d753706d0faf07ac48663a756979d2e.jpg?imageView2/1/w/464/h/644');
...
--
-- Table structure for table `grab_item`
--

DROP TABLE IF EXISTS `grab_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `grab_item` (
  `id` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `grab_session_id_idx` (`session_id`),
  KEY `grab_user_id_idx` (`user_id`),
  CONSTRAINT `grab_session_id` FOREIGN KEY (`session_id`) REFERENCES `session` (`id`),
  CONSTRAINT `grab_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `grab_item`
--

LOCK TABLES `grab_item` WRITE;
/*!40000 ALTER TABLE `grab_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `grab_item` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `record` (
  ...
  `status` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `record_user_id_idx` (`user_id`),
  KEY `record_session_id_idx` (`session_id`),
  CONSTRAINT `record_session_id` FOREIGN KEY (`session_id`) REFERENCES `session` (`id`),
  CONSTRAINT `record_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `session` VALUES (1,1,1,'111111111111001111111111111111111111111111111111111111111111111111111111','2023-05-20 09:00:00',39.50),(2,1,1,'111111111111111111111111111111111111111111111111111111111111111111111111','2023-05-20 12:00:00',39.50),(3,1,1,'111111111111111111111111111111111111111111111111111111111111111111111111','2023-05-20 15:00:00',39.50),(4,2,1,'111111111111111111111111111111111111111111111111111111111111111111111111','2023-05-20 10:00:00',41.00),(5,3,1,'111111111111111111111111111111111111111111111111111111111111111111111111','2023-05-20 12:00:00',40.00),(6,4,1,'111111111111111111111111111111111111111111111111111111111111111111111111','2023-05-20 09:10:00',38.00);
...
CREATE TABLE `ticket` (
  ...
  CONSTRAINT `ticket_order_id` FOREIGN KEY (`order_id`) REFERENCES `new_order` (`id`) ON DELETE CASCADE,
...
INSERT INTO `user` VALUES (1,'customer1',0,'2004-01-01','爱沙尼亚','顾客1',0,NULL,NULL,'customer1','1234'),(2,'user1',0,NULL,NULL,NULL,0,NULL,NULL,'user1','12345'),(4,'111',0,'2001-01-12','SJTU','aaaaaa',0,'se@xxxx','188888888','111','123'),(5,'111',0,'2001-01-12','SJTU','aaaaaa',0,'se@xxxx','188888888','111','123');
...
CREATE TABLE `user_rate` (
  ...
  KEY `rate_movie_id_idx` (`movie_id`),
  CONSTRAINT `rate_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`),
...
-- Dump completed on 2023-06-16 23:40:23
